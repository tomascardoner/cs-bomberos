    ...
    Private Sub buttonGuardar_Click() Handles buttonGuardar.Click
        ...
        If mIsNew Then
            Using dbcMaxID As New CSBomberosContext(True)
                If dbcMaxID.CapacitacionTipo.Where(Function(e) e.IDCapacitacionTipo <> CS_Constants.FIELD_VALUE_OTHER_BYTE).Count = 0 Then
                    mCapacitacionTipoActual.IDCapacitacionTipo = 1
                Else
                    mCapacitacionTipoActual.IDCapacitacionTipo = dbcMaxID.CapacitacionTipo.Where(Function(e) e.IDCapacitacionTipo <> CS_Constants.FIELD_VALUE_OTHER_BYTE).Max(Function(a) a.IDCapacitacionTipo) + CByte(1)
                End If
            End Using
        End If
