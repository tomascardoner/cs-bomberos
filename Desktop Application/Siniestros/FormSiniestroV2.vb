...
#Region "Controls events"
    ...
    Private Sub Controls_GotFocus(sender As Object, e As EventArgs) Handles maskedtextboxNumeroPrefijo.GotFocus, maskedtextboxNumero.GotFocus, textboxSiniestroTipoOtro.GotFocus, NumericUpDownIncendioForestalCantidadHa.GotFocus, NumericUpDownIncendioForestalCantidadPlanta.GotFocus, TextBoxSolicitanteNombre.GotFocus, TextBoxSolicitanteDireccion.GotFocus, TextBoxSolicitanteDocumentoNumero.GotFocus, TextBoxSolicitanteTelefono.GotFocus, TextBoxUbicacionDescripcion.GotFocus, NumericUpDownTrasladoPorOtroCantidad.Enter, NumericUpDownIncendioForestalSuperficieMetro.Enter, NumericUpDownIncendioForestalLargoMetro.Enter, NumericUpDownIncendioForestalCantidadPlanta.Enter, NumericUpDownIncendioForestalCantidadHa.Enter, NumericUpDownIncendioForestalAnchoMetro.Enter, TextBoxUbicacionDescripcion.Enter, TextBoxSolicitanteTelefono.Enter, TextBoxSolicitanteNombre.Enter, TextBoxSolicitanteDocumentoNumero.Enter, TextBoxSolicitanteDireccion.Enter, textboxSiniestroTipoOtro.Enter, maskedtextboxNumeroPrefijo.Enter, maskedtextboxNumero.Enter, textboxNotas.Enter
