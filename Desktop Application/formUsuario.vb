...
#Region "Load and Set Data"
    ...
    Friend Sub SetDataFromObjectToControls()
        With mUsuarioActual
            ...
            CS_ComboBox.SetSelectedValue(comboboxUsuarioGrupo, SelectedItemOptions.ValueOrFirstIfUnique, .IDUsuarioGrupo)
            CS_ComboBox.SetSelectedValue(comboboxCuartel, SelectedItemOptions.ValueOrFirstIfUnique, .IDCuartel, CS_Constants.FIELD_VALUE_NOTSPECIFIED_BYTE)
    ...
    Friend Sub SetDataFromControlsToObject()
        With mUsuarioActual
            ...
            .IDCuartel = CS_ValueTranslation.FromControlComboBoxToObjectByte(comboboxCuartel.SelectedValue, CS_Constants.FIELD_VALUE_NOTSPECIFIED_BYTE)
    ...
    Private Sub buttonGuardar_Click() Handles buttonGuardar.Click
        ...
        If mIsNew Then
            Using dbcMaxID As New CSBomberosContext(True)
                If dbcMaxID.Usuario.Count = 0 Then
