...
#Region "Load and Set Data"
    ...
    Friend Sub SetDataFromControlsToObject()
        With mPersonaCapacitacionActual
            ...
            .IDProvincia = CS_ValueTranslation.FromControlComboBoxToObjectByte(comboboxProvincia.SelectedValue, FIELD_VALUE_NOTSPECIFIED_BYTE)
            .IDLocalidad = CS_ValueTranslation.FromControlComboBoxToObjectShort(comboboxLocalidad.SelectedValue, FIELD_VALUE_NOTSPECIFIED_SHORT)
...
#Region "Controls behavior"
    ...
    Private Sub CapacitacionNivel_SelectedValueChanged() Handles comboboxCapacitacionNivel.SelectedValueChanged
        labelCapacitacionNivelOtro.Visible = (CByte(comboboxCapacitacionNivel.SelectedValue) = FIELD_VALUE_OTHER_BYTE)
        textboxCapacitacionNivelOtro.Visible = (CByte(comboboxCapacitacionNivel.SelectedValue) = FIELD_VALUE_OTHER_BYTE)
    End Sub

    Private Sub CapacitacionTipo_SelectedValueChanged() Handles comboboxCapacitacionTipo.SelectedValueChanged
        labelCapacitacionTipoOtro.Visible = (CByte(comboboxCapacitacionTipo.SelectedValue) = FIELD_VALUE_OTHER_BYTE)
        textboxCapacitacionTipoOtro.Visible = (CByte(comboboxCapacitacionTipo.SelectedValue) = FIELD_VALUE_OTHER_BYTE)
    End Sub
#End Region
    ...
    Private Sub buttonGuardar_Click() Handles buttonGuardar.Click
        ...
        If mPersonaCapacitacionActual.IDCapacitacion = 0 Then
            Using dbcMaxID As New CSBomberosContext(True)
                ...
                If PersonaActual.PersonaCapacitacion.Count = 0 Then
                    mPersonaCapacitacionActual.IDCapacitacion = 1
                Else
                    mPersonaCapacitacionActual.IDCapacitacion = PersonaActual.PersonaCapacitacion.Max(Function(pa) pa.IDCapacitacion) + CByte(1)
                End If
            End Using
        End If
