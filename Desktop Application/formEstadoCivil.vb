    ...
    Private Sub buttonGuardar_Click() Handles buttonGuardar.Click
        ...
        If mIsNew Then
            Using dbcMaxID As New CSBomberosContext(True)
                If dbcMaxID.EstadoCivil.Where(Function(e) e.IDEstadoCivil <> CS_Constants.FIELD_VALUE_OTHER_BYTE).Count = 0 Then
                    mEstadoCivilActual.IDEstadoCivil = 1
                Else
                    mEstadoCivilActual.IDEstadoCivil = dbcMaxID.EstadoCivil.Where(Function(e) e.IDEstadoCivil <> CS_Constants.FIELD_VALUE_OTHER_BYTE).Max(Function(a) a.IDEstadoCivil) + CByte(1)
                End If
            End Using
        End If
