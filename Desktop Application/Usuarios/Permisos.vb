...
#Region "Asignación de permisos"
    ...
    Friend Sub CargarArbolDePermisos(ByRef Arbol As TreeView, ByVal IDUsuarioGrupo As Byte)
        ...
        nodeCurrent = AgregarNodos(nodeRoot, SINIESTROASISTENCIATIPO, "Tipos de Siniestros", SINIESTROASISTENCIATIPO_AGREGAR, DESCRIPCION_AGREGAR, SINIESTROASISTENCIATIPO_EDITAR, DESCRIPCION_EDITAR, SINIESTROASISTENCIATIPO_ELIMINAR, DESCRIPCION_ELIMINAR)
