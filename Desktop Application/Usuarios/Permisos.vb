...
#Region "Definición de constantes"
    ...
    Friend Const COMPRAFACTURA As String = "COMPRAFACTURA"
    Friend Const COMPRAFACTURA_AGREGAR As String = "COMPRAFACTURA_AGREGAR"
    Friend Const COMPRAFACTURA_EDITAR As String = "COMPRAFACTURA_EDITAR"
    Friend Const COMPRAFACTURA_ELIMINAR As String = "COMPRAFACTURA_ELIMINAR"

    Friend Const COMPRAORDENFACTURA As String = "COMPRAORDENFACTURA"
    Friend Const COMPRAORDENFACTURA_AGREGAR As String = "COMPRAORDENFACTURA_AGREGAR"
    Friend Const COMPRAORDENFACTURA_EDITAR As String = "COMPRAORDENFACTURA_EDITAR"
    Friend Const COMPRAORDENFACTURA_ELIMINAR As String = "COMPRAORDENFACTURA_ELIMINAR"
...
#Region "Asignación de permisos comunes"
    ...
    Friend Sub CargarArbolDePermisos(ByRef Arbol As TreeView, ByVal IDUsuarioGrupo As Byte)
        ...
        ' DOCUMENTACIONES
        nodeRoot = Arbol.Nodes.Add("DOCUMENTACIONES", Constantes.MODULO_DOCUMENTACIONES_NOMBRE)
        ...
        ' Jefatura
        nodeRoot = Arbol.Nodes.Add("JEFATURA", Constantes.MODULO_JEFATURA_NOMBRE)
        ...
        ' Comisión directiva
        nodeRoot = Arbol.Nodes.Add("COMISIONDIRECTIVA", Constantes.MODULO_COMISIONDIRECTIVA_NOMBRE)

        ' Comisión directiva - facturas de compra
        AgregarNodos(nodeRoot, COMPRAFACTURA, "Facturas de compra", COMPRAFACTURA_AGREGAR, DESCRIPCION_AGREGAR, COMPRAFACTURA_EDITAR, DESCRIPCION_EDITAR, COMPRAFACTURA_ELIMINAR, DESCRIPCION_ELIMINAR)
        AgregarNodos(nodeRoot, COMPRAORDENFACTURA, "Aplicación de órdenes de compra a facturas.", COMPRAORDENFACTURA_AGREGAR, DESCRIPCION_AGREGAR, COMPRAORDENFACTURA_EDITAR, DESCRIPCION_EDITAR, COMPRAORDENFACTURA_ELIMINAR, DESCRIPCION_ELIMINAR)
