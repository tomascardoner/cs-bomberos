...
#Region "Asignación de permisos"
    ...
    Friend Sub CargarArbolDePermisos(ByRef Arbol As TreeView, ByVal IDUsuarioGrupo As Byte)
        ...
        ' GUARDIA - SINIESTROS
        nodeCurrent = AgregarNodos(nodeRoot, SINIESTRORUBRO, "Rubros de Siniestros", SINIESTRORUBRO_AGREGAR, DESCRIPCION_AGREGAR, SINIESTRORUBRO_EDITAR, DESCRIPCION_EDITAR, SINIESTRORUBRO_ELIMINAR, DESCRIPCION_ELIMINAR)
        nodeCurrent = AgregarNodos(nodeRoot, SINIESTROTIPO, "Tipos de Siniestros", SINIESTROTIPO_AGREGAR, DESCRIPCION_AGREGAR, SINIESTROTIPO_EDITAR, DESCRIPCION_EDITAR, SINIESTROTIPO_ELIMINAR, DESCRIPCION_ELIMINAR)
        nodeCurrent = AgregarNodos(nodeRoot, SINIESTROASISTENCIATIPO, "Tipos de Asistencia de Siniestros", SINIESTROASISTENCIATIPO_AGREGAR, DESCRIPCION_AGREGAR, SINIESTROASISTENCIATIPO_EDITAR, DESCRIPCION_EDITAR, SINIESTROASISTENCIATIPO_ELIMINAR, DESCRIPCION_ELIMINAR)
