        ...
        Else
            If Permisos.VerificarPermiso(Permisos.PARENTESCO_ELIMINAR) Then
                ...
                Using dbContext = New CSBomberosContext(True)
                    Dim ParentescoActual As Parentesco = dbContext.Parentesco.Find(CType(datagridviewMain.SelectedRows(0).DataBoundItem, Parentesco).IDParentesco)
                    Dim Mensaje As String
                    Mensaje = String.Format("Se eliminará el Parentesco seleccionado.{0}{0}{1}{0}{0}¿Confirma la eliminación definitiva?", vbCrLf, ParentescoActual.Nombre)
                    If MsgBox(Mensaje, CType(MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, MsgBoxStyle), My.Application.Info.Title) = MsgBoxResult.Yes Then

                        Try
                            dbContext.Parentesco.Remove(ParentescoActual)
