...
Partial Public Class Usuario
    ...
    Public Overridable Property SiniestroVehiculoMarcasCreadas As ICollection(Of SiniestroVehiculoMarca) = New HashSet(Of SiniestroVehiculoMarca)
    Public Overridable Property SiniestroVehiculoMarcasModificadas As ICollection(Of SiniestroVehiculoMarca) = New HashSet(Of SiniestroVehiculoMarca)
    ...
    Public Overridable Property SiniestroDamnificadoEstadosCreados As ICollection(Of SiniestroDamnificadoEstado) = New HashSet(Of SiniestroDamnificadoEstado)
    Public Overridable Property SiniestroDamnificadoEstadosModificados As ICollection(Of SiniestroDamnificadoEstado) = New HashSet(Of SiniestroDamnificadoEstado)
