...
Partial Public Class Persona
    ...
    Public Overridable Property SiniestrosComoEncargadoCuartel As ICollection(Of Siniestro) = New HashSet(Of Siniestro)
    Public Overridable Property SiniestrosComoJefeGuardia As ICollection(Of Siniestro) = New HashSet(Of Siniestro)
    Public Overridable Property SiniestrosComoRadioTelefonista As ICollection(Of Siniestro) = New HashSet(Of Siniestro)
