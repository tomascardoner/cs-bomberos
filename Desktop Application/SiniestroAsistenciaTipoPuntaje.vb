...
Partial Public Class SiniestroAsistenciaTipoPuntaje
    ...
    Public Property PuntosClaveVerde As Byte
    Public Property PuntosClaveAzul As Byte
    Public Property PuntosClaveNaranja As Byte
    Public Property PuntosClaveRoja As Byte
