        ...
        If Not mSkipFilterData Then
            ...
            Try
                ...
                If comboboxRubro.SelectedIndex > 0 Then
                    If CShort(comboboxRubro.ComboBox.SelectedValue) = CardonerSistemas.Constants.FIELD_VALUE_NOTSPECIFIED_BYTE Then
                        mlistElementosFiltradaYOrdenada = mlistElementosFiltradaYOrdenada.Where(Function(e) e.IDRubro = CardonerSistemas.Constants.FIELD_VALUE_NOTSPECIFIED_BYTE).ToList
                    Else
                ...
                If comboboxSubRubro.SelectedIndex > 0 Then
                    If CShort(comboboxSubRubro.ComboBox.SelectedValue) = CardonerSistemas.Constants.FIELD_VALUE_NOTSPECIFIED_SHORT Then
                        mlistElementosFiltradaYOrdenada = mlistElementosFiltradaYOrdenada.Where(Function(e) e.IDSubRubro = CardonerSistemas.Constants.FIELD_VALUE_NOTSPECIFIED_SHORT).ToList
                    Else
