...
#Region "Load and Set Data"
    ...
    Friend Sub RefreshData(Optional ByVal PositionIDSiniestroAsistenciaTipo As Byte = 0, Optional ByVal RestoreCurrentPosition As Boolean = False)
        ...
        Catch ex As Exception
            ...
            CardonerSistemas.ErrorHandler.ProcessError(ex, "Error al leer los Tipos de Asistencia de Siniestros.")
        ...
        If Not mSkipFilterData Then
            ...
            Try
                ...
                Select Case mlistSiniestroAsistenciaTiposFiltradaYOrdenada.Count
                    Case 0
                        statuslabelMain.Text = String.Format("No hay Tipos de Asistencia de Siniestros para mostrar.")
                    Case 1
                        statuslabelMain.Text = String.Format("Se muestra 1 Tipo de Asistencia de Siniestro.")
                    Case Else
                        statuslabelMain.Text = String.Format("Se muestran {0} Tipos de Asistencia de Siniestros.", mlistSiniestroAsistenciaTiposFiltradaYOrdenada.Count)
                End Select
...
#Region "Main Toolbar"
    ...
    Private Sub Editar_Click() Handles buttonEditar.Click
        If datagridviewMain.CurrentRow Is Nothing Then
            MsgBox("No hay ningún Tipo de Asistencia de Siniestros para editar.", vbInformation, My.Application.Info.Title)
        Else
    ...
    Private Sub Eliminar_Click() Handles buttonEliminar.Click
        If datagridviewMain.CurrentRow Is Nothing Then
            MsgBox("No hay ningún Tipo de Asistencia de Siniestros para eliminar.", vbInformation, My.Application.Info.Title)
        Else
            If Permisos.VerificarPermiso(Permisos.SiniestroAsistenciaTipo_ELIMINAR) Then
                ...
                Mensaje = String.Format("Se eliminará el Tipo de Asistencia de Siniestros seleccionado.{0}{0}Nombre: {1}{0}{0}¿Confirma la eliminación definitiva?", vbCrLf, CType(datagridviewMain.SelectedRows(0).DataBoundItem, SiniestroAsistenciaTipo).Nombre)
                    ...
                    Catch dbuex As System.Data.Entity.Infrastructure.DbUpdateException
                        Select Case CardonerSistemas.Database.EntityFramework.TryDecodeDbUpdateException(dbuex)
                            Case CardonerSistemas.Database.EntityFramework.Errors.RelatedEntity
                                MsgBox("No se puede eliminar el Tipo de Asistencia de Siniestros porque tiene datos relacionados.", MsgBoxStyle.Exclamation, My.Application.Info.Title)
                        End Select
                        Me.Cursor = Cursors.Default
                        Exit Sub

                    Catch ex As Exception
                        CardonerSistemas.ErrorHandler.ProcessError(ex, "Error al eliminar el Tipo de Asistencia de Siniestros.")
                    End Try
    ...
    Private Sub Ver() Handles datagridviewMain.DoubleClick
        If datagridviewMain.CurrentRow Is Nothing Then
            MsgBox("No hay ningún Tipo de Asistencia de Siniestros para ver.", vbInformation, My.Application.Info.Title)
        Else
            Me.Cursor = Cursors.WaitCursor
