        ...
        If Not mSkipFilterData Then
            ...
            Try
                ...
                If comboboxCuartel.SelectedIndex > 0 Then
                    mlistUsuariosFiltradaYOrdenada = mlistUsuariosFiltradaYOrdenada.Where(Function(p) p.IDCuartel.HasValue AndAlso p.IDCuartel.Value = CByte(comboboxCuartel.ComboBox.SelectedValue)).ToList
                End If
