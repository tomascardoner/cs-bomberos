...
Partial Public Class Usuario
    ...
    Public Overridable Property Elemento1 As ICollection(Of Elemento) = New HashSet(Of Elemento)
    Public Overridable Property PersonaAccidente As ICollection(Of PersonaAccidente) = New HashSet(Of PersonaAccidente)
    Public Overridable Property PersonaAccidente1 As ICollection(Of PersonaAccidente) = New HashSet(Of PersonaAccidente)
    Public Overridable Property PersonaAltaBaja As ICollection(Of PersonaAltaBaja) = New HashSet(Of PersonaAltaBaja)
    Public Overridable Property PersonaAltaBaja1 As ICollection(Of PersonaAltaBaja) = New HashSet(Of PersonaAltaBaja)
