...
#Region "Constantes"
    ...
    ' SINIESTROS
    Friend Const SINIESTRO_ASISTENCIATIPO_PRESENTE_ID As String = "SINIESTRO_ASISTENCIATIPO_PRESENTE_ID"
    Friend Const SINIESTRO_ASISTENCIATIPO_LICENCIA_ID As String = "SINIESTRO_ASISTENCIATIPO_LICENCIA_ID"
    Friend Const SINIESTRO_ASISTENCIATIPO_SUSPENSION_ID As String = "SINIESTRO_ASISTENCIATIPO_SUSPENSION_ID"
    Friend Const SINIESTRO_ASISTENCIATIPO_ENCOMISION_ID As String = "SINIESTRO_ASISTENCIATIPO_ENCOMISION_ID"
    Friend Const SINIESTRO_ASISTENCIATIPO_SALIDAANTICIPADA_ID As String = "SINIESTRO_ASISTENCIATIPO_SALIDAANTICIPADA_ID"
    Friend Const SINIESTRO_RUBRO_ID_INCENDIO As String = "SINIESTRO_RUBRO_ID_INCENDIO"
    Friend Const SINIESTRO_TIPO_ID_INCENDIO_FORESTAL As String = "SINIESTRO_TIPO_ID_INCENDIO_FORESTAL"

    ' ACADEMIAS
    Friend Const ACADEMIA_ASISTENCIATIPO_PRESENTE_ID As String = "ACADEMIA_ASISTENCIATIPO_PRESENTE_ID"
    Friend Const ACADEMIA_ASISTENCIATIPO_LICENCIA_ID As String = "ACADEMIA_ASISTENCIATIPO_LICENCIA_ID"
    Friend Const ACADEMIA_ASISTENCIATIPO_SUSPENSION_ID As String = "ACADEMIA_ASISTENCIATIPO_SUSPENSION_ID"
    Friend Const ACADEMIA_ASISTENCIATIPO_FUERAHORA_ID As String = "ACADEMIA_ASISTENCIATIPO_FUERAHORA_ID"
